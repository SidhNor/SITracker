...
public class ViewPublicationEvent extends FBAEvent {
    public ViewPublicationEvent(String publicationName, String publicationUrl) {
        super(FirebaseAnalytics.Event.VIEW_ITEM);
        getParamMap().put(FirebaseAnalytics.Param.ITEM_ID, publicationUrl);
        getParamMap().put(FirebaseAnalytics.Param.ITEM_NAME, publicationName);
