...
public class SelectAuthorEvent extends FBAEvent {
    public SelectAuthorEvent(String authorName, String authorUrl) {
        ...
        getParamMap().put(FirebaseAnalytics.Param.CONTENT_TYPE, "author");
    }
}
