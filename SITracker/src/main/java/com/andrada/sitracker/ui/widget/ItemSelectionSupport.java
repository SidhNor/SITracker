...
public class ItemSelectionSupport {
    ...
    public static ItemSelectionSupport addTo(RecyclerView recyclerView) {
        ...
        if (itemSelectionSupport == null) {
            ...
            recyclerView.setTag(R.id.recycleview_item_selection_support, itemSelectionSupport);
        } else {
            // TODO: Log warning
        }
    ...
    public static void removeFrom(RecyclerView recyclerView) {
        ...
        recyclerView.setTag(R.id.recycleview_item_selection_support, null);
    }
    ...
    public static ItemSelectionSupport from(RecyclerView recyclerView) {
        ...
        return (ItemSelectionSupport) recyclerView.getTag(R.id.recycleview_item_selection_support);
    }
