...
public class ItemClickSupport {
    ...
    public static ItemClickSupport addTo(RecyclerView recyclerView) {
        ...
        if (itemClickSupport == null) {
            ...
            recyclerView.setTag(R.id.recycleview_item_click_support, itemClickSupport);
        } else {
            // TODO: Log warning
        }
    ...
    public static void removeFrom(RecyclerView recyclerView) {
        ...
        recyclerView.setTag(R.id.recycleview_item_click_support, null);
    }
    ...
    public static ItemClickSupport from(RecyclerView recyclerView) {
        ...
        return (ItemClickSupport) recyclerView.getTag(R.id.recycleview_item_click_support);
    }
